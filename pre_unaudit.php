...
$addslashed_unaudit=_nodesforum_my_custom_addslashes($_GET['_nodesforum_unaudit']);
//get info about post or folder to unaudit
...
//if has the right to unaudit..
if($_nodesforum_righttoaudit==1){
    $unaudit_authority=$_nodesforum_modship_authoritative_folder;
    ...
    // {
        ...
        mysql_query("UPDATE ".$_nodesforum_db_table_name_modifier."_nodesforum_folders_and_posts SET audited = 0 WHERE fapID = '$addslashed_unaudit'");
	...
	// }else{
        ...
        //$location.='#_nodesforum_anchor_'.$_GET['_nodesforum_unaudit'];
		header($location);
	// }
}
