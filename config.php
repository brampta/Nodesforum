...
$_nodesforum_forum_name='Happy Forum'; //the name of your forum
...
$_nodesforum_validate_email_address_from='admin@mydomain.com'; //validation emails sent from your server will be from this address
$_nodesforum_validate_resend_password_from='admin@mydomain.com'; //password reset request links sent from your server will be from this address
$_nodesforum_instance_asolute_URL='http://mydomain.com/forum'; //emails sent by your server need to contain links that link back to the forum. this must be set to the URL of the root of the forum. the URL after which we can add a ? and then some variables
...
$_nodesforum_max_title_length=100; //max lenght of a title
$_nodesforum_max_word_length_in_titles=30; //max word lenght in titles
$_nodesforum_max_word_length_in_posts=60; //max word lenght in posts
